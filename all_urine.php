	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					<div class="responsive-logo">
						<a href="lab.php"><img src="images/logo-dark.png" class="logo" alt="logo"></a>
					</div>
					<ul class="nav">
			...
			<div class="row no-margin-padding">
				<div class="col-md-6">
					<h3 class="block-title">All Urine Tests</h3>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">						
								...
								<table id="tableId" class="table table-bordered table-striped">
									...
									<tbody>
										<tr>
                                            ...
                                            // Check connection
                                            $sql = "SELECT * FROM urine_analysis";
                                             ...
                                             if (mysqli_num_rows($result) > 0) {
                                               while($row =mysqli_fetch_assoc($result)) {
												$id=$row['id'];
 												 ...
 												 echo"<td><a  id='name' href='about-urine.php?id={$id}' >".$row['id']."</a></td>";                                                    echo"<td  ><a  id='name' href='#' >".$row['color']."</a>";
