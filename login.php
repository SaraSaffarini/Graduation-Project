...
<body class="auth-bg">
	...
	<div class="wrapper">
		 <!-- Page Content -->
		 <div id="content">
        <nav class="navbar navbar-default"  style="background-color: #415A77">
            <div class="container-fluid" >
                <ul class="nav" style="padding: 5px">
                    <div><a href="home.html"> <img src="images/logo.png" style="border-radius: 50% ;width: 60px;height: 60px;float: left"></a></div>
                    <div style="margin-left: 1200px ;display: flex">
                   
                        <div style="margin-left: 40px;margin-top: 15px ;">
                            <a href="login.php" style="color: white;">Login  </a></div>
                    <div style="margin-left: 40px;margin-top: 15px">
                        <a href="Home.html" style="color: white;">Home </a></div>
                    </div>
                </ul>
		...
		<!-- Page Content  -->
		<div id="content" style="margin-left: 40px; margin-top: 55px" >
			<div class="container-fluid">
				<div class="row">
